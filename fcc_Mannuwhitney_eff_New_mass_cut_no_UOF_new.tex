...
The variable $N$-subjettiness~\cite{}, denoted by $\tau_N$, is designed to 
...
exclusive $k_{t}$ algorithm~\cite{} and reversing the last N clustering steps. 
...
Following the suggestion by Ref.~\cite{}, requirement on the 
...
The energy correlation function (ECF)~\cite{} is defined as follows: 

...
requires an appropriate detector design. The most important for reconstruction of such jets are tracking and calorimeter.
...
of detector performance, testing new technology options, an event reconstruction techniques for future
100~TeV colliders.
...
$0.1\times0.1$, $0.01\times0.01$ and  $0.005\times0.005$, respectively.
...
\input{fcc_Mass_soft_drop_for_paper_new_no_UOF_total.tex}

\input{fcc_Mannuwhitney_eff_New_mass_cut_no_UOF_new.tex}


\input{fcc_conclusion.tex}

...
reconstructed using truth-level particles. The distributions reconstructed with the cell sizes of 
1~$\times$~1~cm$^2$ and 5~$\times$~5~cm$^2$ are closer to the 
truth-level variables compared to the distributions reconstructed using 
the cell size of 20~$\times$20~cm$^2$. In terms of similarity of the 
reconstructed distributions to the truth-level distributions, there is 
no significant difference between 5~$\times$~5~cm$^2$ and 
1~$\times$~1~cm$^2$ cell sizes. 

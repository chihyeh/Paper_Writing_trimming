...
\begin{center}
   ...
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_010_mass_mmdt_20tev_04_no_UOF.eps}
   }
      \subfigure[5$\times$5($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_009_mass_mmdt_20tev_04_no_UOF.eps}\hfill
   }
   \subfigure[1$\times$1($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_012_mass_mmdt_20tev_04_no_UOF.eps}\hfill
   }
\end{center}
...
\begin{center}
   \subfigure[5$\times$5 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_010_mass_mmdt_tt_20tev_04_tt_no_UOF.eps}
   }
   \subfigure[20$\times$20 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_009_mass_mmdt_tt_20tev_04_tt_no_UOF.eps}\hfill
   }
   \subfigure[1$\times$1 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_012_mass_mmdt_tt_20tev_04_tt_no_UOF.eps}\hfill
   }
\end{center}
\caption{
...
\begin{center}
   \subfigure[20$\times$20 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_010_mass_sdb2_ww_20tev_04_1600_no_UOF.eps}
   }
    \subfigure[5$\times$5 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_009_mass_sdb2_ww_20tev_04_1600_no_UOF.eps}\hfill
   }
   \subfigure[1$\times$1 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_012_mass_sdb2_ww_20tev_04_1600_no_UOF.eps}\hfill
   }
\end{center}
\caption{
...
\begin{center}
   \subfigure[20$\times$20 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_010_mass_sdb2_tt_20tev_04_tt_2400_no_UOF.eps}
   }
   \subfigure[5$\times$5 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_009_mass_sdb2_tt_20tev_04_tt_2400_no_UOF.eps}\hfill
   }
   \subfigure[1$\times$1 ($cm^2$)] {
   \includegraphics[   width=0.45\textwidth]{h_soft_drop/Dis_cluster_012_mass_sdb2_tt_20tev_04_tt_2400_no_UOF.eps}\hfill
   }
\end{center}
\caption{
Distributions of soft drop mass for $\beta$=2, with 20 TeV c.m. energies and three different detector cell sizes: 20$\times$20, 
